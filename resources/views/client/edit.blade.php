                ...
                <div class="card-body">
                    <form action="{{ route('client.update', $client->id) }}" method="post">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input class="form-control @error('prenom') is-invalid @enderror" id="" name="prenom" value="{{ $client->prenom }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('adresse') is-invalid @enderror" id="" name="adresse" value="{{ $client->adresse}}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input type="number" class="form-control @error('numeroTelephone') is-invalid @enderror" id="" name="numeroTelephone" value="{{ $client->numeroTelephone}}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <select name="sexe" id="" class="form-control">
                                    <option value="{{$client->sexe}}"></option>
